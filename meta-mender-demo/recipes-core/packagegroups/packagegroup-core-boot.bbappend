RDEPENDS_${PN}_append_mender-enabled = " hello-mender boot-script"

# This is for tests. Without the tests creating a special file, the service will
# do nothing.
RDEPENDS_${PN}_append_mender-enabled = "${@bb.utils.contains_any('MENDER_MACHINE', 'vexpress-qemu vexpress-qemu-flash qemux86-64 qemuxu86', 'mender-reboot-detector', '', d)}"
...
RDEPENDS_${PN}_append_mender-enabled = " lsb-ld"
